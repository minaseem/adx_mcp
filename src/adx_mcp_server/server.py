...
dotenv.load_dotenv()
mcp = FastMCP("Azure Data Explorer MCP", host="0.0.0.0", port=3001)
...
config = ADXConfig(
    cluster_url=os.environ.get("ADX_CLUSTER_URL", "https://prodmetricsfollower1.eastus2.kusto.windows.net/"),
    database=os.environ.get("ADX_DATABASE", "Metrics"),
)
